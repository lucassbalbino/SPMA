...
- **Próxima feature:** `formulario-pos-curso` (README, ordem sugerida item 5). Terceiro formulário (`TB_Pos_Curso`, GO, durante+depois do curso) - ver seção 5 do documento fonte para o dicionário de campos e regras próprias (diferentes do Pré-Curso).
